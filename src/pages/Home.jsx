...
export default function Home() {
    ...
    return (
        <>
            ...
            <Projects projects={[
                { title: 'Ip address tracker', description: 'A web application that pinpoints geographical locations based on IP addresses, built to demonstrate mastery of APIs and geolocation services', image: './ipaddresstracker.png',linkk:'https://github.com/S672672/IpAddressTracker-using-react',Live:"https://trackaddress.netlify.app/" },
                { title: 'PlayeTube', description: 'A video playing application created using nextjs to watch videos', image: './playetube.png',linkk:'https://github.com/S672672/playtube', Live:'https://playetubee.netlify.app/' },
                ...
                {title:'Hamro Mart' ,description:'A web application for grocery mart, helping to track stock availability efficiently. Built to streamline the operational workflow.',image:'./inventory.png',linkk:'https://github.com/S672672/Inventory_tracking'},
